  ...
  return <main className={css.pagina}>
    <div className={css.conteudo}>
      <div className={css.grade}>
        <div className={css.apresentacao}><Link href="/" className={css.marca} aria-label="Didaticus, voltar ao site"><span className={css.marcaArte} aria-hidden="true"><span className={css.marcaBase} /><span className={css.marcaTitulo} /><span className={css.marcaSubtitulo} /></span></Link><span className={css.selo}>ÁREA DA FAMÍLIA</span><h1>Acompanhe cada passo <em>mais de perto.</em></h1><p>Aulas, pagamentos e pedidos reunidos para você acompanhar a rotina de estudos do seu filho.</p><div className={css.detalhe}><strong>Seu acesso é pessoal</strong><small>Use o e-mail e a senha cadastrados pela equipe da Didaticus.</small></div></div>
